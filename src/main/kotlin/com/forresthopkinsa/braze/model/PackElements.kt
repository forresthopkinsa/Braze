...
data class Pack(
    ...
    override val versions: List<IndexedPackVersion>
) : Element<Pack, SimplePack> {
    override fun simplify() = SimplePack(slug, name, author, description, link, donate)
}

data class SimplePack(
    override val slug: String,
    override var name: String,
    var author: String,
    var description: String,
...
data class IndexedPackVersion(
    ...
    var memory: Int?,
    var modList: List<SimpleModVersion>
) : IndexedVersion<PackVersion> {
